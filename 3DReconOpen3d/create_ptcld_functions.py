...
class RGBD:
    def __init__(self, data_type = 0, rgb_path = '', depth_path = '', np_rgb = None, np_depth = None): # basic format
        self.data_type = data_type # data_type: {0: 기본, 1: TUM, 2:np 입력}
    ...
    def rgbdpath_to_o3drgbd(self):
        ...
        try:
            ...
            if self.data_type == 0: # basic
                rgbd_image = o3d.geometry.RGBDImage.create_from_color_and_depth(color_raw, depth_raw) #convert_rgb_to_intensity = False)
            elif self.data_type == 1: # TUM
...
class PCD:
    ...
    def run(
        ...
        return self.create_pcd_from_rgbd(intrinsic, extrinsic)
